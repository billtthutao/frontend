<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column header-align="center" align="center" label="品牌logo地址">
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="updateCatelogHandle(scope.row.brandId)">关联</el-button>
    ...
    <el-dialog title="关联分类" :visible.sync="cateRelationDialogVisible" width="30%">
      ...
      <el-popover placement="right" width="400" trigger="click" v-model="popCatelogSelectVisible">
        <!--el-cascader v-model="catelogPath" :options="products" :props="props" filterable placeholder="试试搜索: 手机"></el-cascader-->
        <category-cascader :catelogPath.sync="catelogPath"></category-cascader>
        <div style="text-align: right; margin: 0">
          <el-button size="mini" type="text" @click="popCatelogSelectVisible = false">取消</el-button>
          <el-button type="primary" size="mini" @click="addCatelogSelect">确定</el-button>
...
export default {
  ...
  methods: {
    ...
    deleteCateRelationHandle(rowId, brandId) {
      console.log("rowId",rowId);
      console.log("brandId",brandId);
      this.$http({
      url: this.$http.adornUrl('/product/categorybrandrelation/delete'),
      method: 'post',
      data: this.$http.adornData([rowId], false)
      }).then(({ data }) => {
        this.getCateRelation();
       });
    },
